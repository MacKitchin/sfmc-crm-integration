...
- **Example rows:**
  - `EventTechNewsletter_Form` → `BizBash_Event_Tech__c` + `BizBash_Event_Tech_Date__c`
...
- **Purpose:** Maps each `Source` value to a Salesforce Campaign ID for Campaign Member creation
- **Columns:** Source, CampaignId
